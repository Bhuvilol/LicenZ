        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Set the price for others to license this content
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              Describe the terms and conditions of the license
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center">
        ...
        {!walletConnected && (
          <p className="text-sm text-gray-500 mt-2">
            Please connect your MetaMask wallet to create licenses
          </p>
        )}
      </div>
